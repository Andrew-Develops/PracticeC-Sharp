...
namespace BattleshipLiteLibrary
{
    ...
    {
        public static int GetShootCount(PlayerInfoModel player)
        {
            int shotCount = 0;
        ...
        public static bool PlaceShip(PlayerInfoModel model, string location)
        {
            ...
            // validam daca locatia aleasa este valida
            bool isValidLocation = ValidateGridLocation(model, row, column);

            // verificam daca locatia aleasa este libera, sau se afla deja o nava acolo
        ...
        public static (string row, int column) SplitShotIntoRowAndColumn(string shot)
        {
            ...
            if (shot.Length != 2)
            {
                throw new ArgumentException("This was an ivalida shot type.", shot);
            }
